...
<!-- 
adjusting and transformating data can makes the historical data less complex so a simpler forecast model can be used. It is also a good idea to remove the underline factors affected the time series like workday, inflation, population, and currancy exchange rate etc.-->
