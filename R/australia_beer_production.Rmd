...
# weighted average of observations where weight decay is exponential
# y(3) = alpha.y(2) + alpha(1-alpha).y(1) + alpha(1-alpha)^2.y(0)

beer.ts2 <- window(beer.ts, start = 1993)
plot.ts(beer.ts2[,2], main = "Monthly Beer Production in Australia",
        xlab = "Year", ylab = "ML")
...
plot(beer.fit.ses1, type="o", main = "Monthly Beer Production in Australia", 
     xlab = "Year", ylab = "ML")
